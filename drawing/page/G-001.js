...
var mk_page = function(settings){
  ...
  var notes =     [
    ...
    '9.) ALL WIRE TERMINATIONS SHALL BE APPROPRIATELY LABELED AND READILY ACCESSIBLE.',
    '10.) IF APPLICABLE, MODULE GROUNDING LUGS MUST BE INSTALLED AT THE MARKED GROUNDING LUG HOLES PER THE MANUFACTURER\' INSTALLATION REQUIREMENTS',
    '11.) AS INDICATED BY DESIGN, OTHER NTRL LISTED MODULE GROUNDING DEVICES MAY BE USED IN PLACE OF STANDARD GROUNDING LUGS AS SHOWN IN MANUFACTURER DOCUMENTATION,',
    '     AND APPROVED BY THE AHJ.',
    '12.) CONDUIT AND WIRE SPECIFICATIONS ARE BASED ON A MINIMUM CODE REQUIREMENTS AND ARE NOT MEANT TO LIMIT UP-SIZING AS REQUIRED BY FIELD CONDITIONS.',
    '13.) THE AMBIENT TEMPERATURE CORRECTION FACTORS ARE BASED ON 36 DEGREE C (97 DEGREE F)',
    '14.) THE UTILITY WILL NEED TO CHANGE THE METER TO ONE THAT IS APPROVED FOR NET METERING PER FBC 107',
    ' ',
    'EQUIPMENT LOCATIONS',
