...
permit = {
  ...
  createPDF: function(url, callback) {
    ...
    logger.info("createPDF(%s) %s", pdfName, url);
    ...
    phantom.create(function (ph) {
      ...
      ph.createPage(function (page) {
        ...
        page.open(url, function (status) {
          logger.info("createPDF() FileName: %s", pdfDirectory + pdfName);

          page.render(pdfDirectory + pdfName, function() {
            logger.info('PDF File Created: ' + pdfName);
            ph.exit();
  ...
  getWind: function(latitude, longitude, callback) {
    ...
    phantom.create(function (ph) {
      ph.createPage(function (page) {
        ...
        page.open(url, function (status) {
          logger.info("getWind(): Opening %s: %s", url, status);
