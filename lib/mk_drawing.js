...
var mk_drawing = function(settings){
  ...
  if( settings.state.system.array.modules_per_string > max_displayed_modules ){
    ...
    settings.drawing.displayed_modules = settings.state.system.array.modules_per_string;
