...
var mk_drawing = function(settings){
  ...
  console.log( 'settings.drawing_settings.loc.array.left', settings.drawing_settings.loc.array.left );
  console.log( 'settings.drawing_settings.size.string.w', settings.drawing_settings.size.string.w );
  ...
  console.log( 'settings.drawing_settings.loc.array.right', settings.drawing_settings.loc.array.right );
