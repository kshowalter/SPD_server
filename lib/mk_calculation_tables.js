var mk_system_display = function(system_settings){
  ...
  if( system.config.system_type === 'string' ){
    system_display['String Inverter'] = [
      ['DESCRIPTION','SYMBOL','CALCULATION','VALUE','UNIT'],
  ...
  system_display['Interconnection Calculations'] = [
    ['DESCRIPTION','SYMBOL','CALCULATION','RESULT'],
    ['Sum of inverter output current.','interconnection.inverter_output_cur_sum', 'source.current * array.num_of_strings',intercon.inverter_output_cur_sum.toFixed(2)+' A'],
