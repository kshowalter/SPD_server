...
var SDA = function(system_settings){
  ...
  ******************/
  var circuit_names = [
    'exposed source circuit wiring',// exposed source circuit wiring
  ...
  circuits['exposed source circuit wiring'].temp_adder = lookup( module.array_offset_from_roof, tables[1] );
