...
var mk_PDF = {
   ...
   *****************************************************************************************************/
  download: function(system_settings) {
    var host = system_settings.server.host;

    var module = system_settings.state.system.array.module;
    var inverter = system_settings.state.system.inverter.inverter_specs;
