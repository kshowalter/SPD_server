...
var SDA = function(system_settings){
  ...
  error_check.current_check_inverter = array.pmp > ( inverter.max_ac_output_current * interconnection.grid_voltage * inverter.oversize_limit );
  // If error check is true, flag system design failure, and report notice to user.
  if( error_check.current_check_inverter ){ report_error( 'PV output power exceeds the inverter maximum.' );}
  ...
  circuit_names.forEach(function(circuit_name, i){
    ...
    circuit.conductor_size_OCPD_min = '';
