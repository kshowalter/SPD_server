var mk_blocks = function(settings){
  ...
  // connector_QD
  d.block_start('connector_QD');
  d.layer('AC_connector');
  x = 0;
  y = 0;
  w = size.connector_QD.w;
  h = size.connector_QD.h;
  ...
  // connector_block
  d.block_start('connector_block');
  d.layer('connector_block');
  x = 0;
  y = 0;
  w = 7;
  h = 3;
  ...
  d.line([
    [ x - jb.w/4, y ],
    [ x - jb.w/4, h/3-size.connector_QD.w/2 ],
  ]);
  d.block('connector_QD', [ x - jb.w/4, h/3 ]).rotate(90);
  d.line([
    [ x - jb.w/4, h/3+size.connector_QD.w/2 ],
    [ x - jb.w/4, h/2 + size.microinverter.h/3 - size.microinverter.h/2 ],
  ]);
  d.layer('DC_pos');
  d.line([
    [ x + jb.w/4, y ],
  ...
  d.line([
    [ x, y ],
    [ x, size.module.h*6.5/8 ],
  ]);
  d.block('connector_block', [ x, size.module.h*6.5/8 - 0 ]);
  ...
  // Module
  d.block_start('module optimizer');
  ...
  w = size.module.frame.w;
  h = size.module.frame.h;
  for( var r=0; r<settings.drawing.module_count; r++){
    d.block('module', [x,y]);
    x += size.module.w;
  }
