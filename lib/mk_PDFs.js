...
var render_PDF = function(html, write_path, callback){
  ...
  //html = simple_svg;
  html = html.replace(/<svg /g, '<svg style="position:absolute; top:0px; left:0px; padding=0px; margin:0px;" ');
  html = html.replace('viewBox="0 0 1000 772 "', 'viewBox="0 115 1010 780"');
  ...
  phantom.create().then(function(ph){
    ...
    //  top: 0,
    //  left: 0,
    //  width: page_width-800,
    //  height: page_height-2000
    //});
