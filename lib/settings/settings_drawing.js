var settings_drawing = function(settings){
  ...
  loc.rapid_shutdown = {
    x: loc.DC_jb_box.x,
    y: loc.DC_jb_box.y - size.DC_jb_box.h/2 - size.rapid_shutdown.h/2 - 5
  };
  ...
  loc.AC_loadcenter.L2.x = loc.AC_loadcenter.x + size.AC_loadcenter.bar.offset;
  loc.AC_loadcenter.L1 = {};
  loc.AC_loadcenter.L1.x = loc.AC_loadcenter.x - size.AC_loadcenter.bar.offset;
  ...
  loc.meter = {
    ...
    y: loc.AC_loadcenter.top - size.meter.h/2 - 10,
  };
  ...
  size.tables = {
    ...
    row_height: 10,
    table_spacing: 14,
    text_cell_size_fixed: 20,
    font_letter_width: 4.1,
