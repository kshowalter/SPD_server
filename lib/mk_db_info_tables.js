...
var mk_db_info_tables = function(system_settings){
  ...
  db_info_tables['Module Specifications from Database'] = [
  ...
  if( system.config.system_type === 'optimizer' ){
    db_info_tables['Optimizer Specifications from Database'] = [
      ['DESCRIPTION','SYMBOL','VALUE'],
  ...
  db_info_tables['Inverter Specifications from Database'] = [
    ['DESCRIPTION','SYMBOL','VALUE'],
  ...
  if( inverter.max_dc_inputpower ){
    db_info_tables['Inverter Specifications from Database'].push(
  ...
  if( system.config.system_type === 'micro' ){
    db_info_tables['Inverter Specifications from Database'] = db_info_tables['Inverter Specifications from Database'].concat([
      ['Maximum DC input power','inverter.max_ac_output_current',display_value(inverter.max_ac_output_current, 'W')],
