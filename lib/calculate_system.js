...
//console.log( 'if', sf.if(2>1,'yes','no') );
//console.log( 'or', sf.or(false,false,true,false) );
//console.log( 'and', sf.and(true,true,true) );
//console.log( 'and', sf.and(true,true,false,true) );
//console.log( 'max', sf.max(0,-1,2,3,3,2,2,1,0) );
//console.log( 'min', sf.min(0,-1,2,3,3,2,2,1,0) );
...
var calculate_system = function(system_settings){
  ...
  ******************/
  circuit_names.forEach(function(circuit_name){
    ...
    var circuit = TEMP_circuits[circuit_name];
    ...
    //circuit.next_largest_OCPD = lookup( circuit.min_req_cond_current, tables[6], 0, true);
