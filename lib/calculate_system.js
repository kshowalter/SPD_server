...
var calculate_system = function(settings){
  ...
  system.array.isc = system.module.isc * system.array.num_of_strings;
  system.array.voc = system.module.voc * system.array.num_of_modules;
  system.array.imp = system.module.imp * system.array.num_of_strings;
  system.array.vmp = system.module.vmp * system.array.num_of_modules;
  system.array.pmp = system.array.vmp  * system.array.imp;
  system.array.number_of_modules = system.array.num_of_modules * system.array.num_of_strings;
  ...
  ***********/
  ...
  system.array.maximum_modules_in_series = system.array.num_of_modules;
  //Minimum Number of Series-Connected Modules per Source Circuit
  system.array.minimum_modules_in_series = system.array.num_of_modules;
  ...
  ******************/
  ...
  var n = settings.state.system.array.num_of_strings * 2;
