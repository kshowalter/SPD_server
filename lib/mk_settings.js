...
var mk_settings = function(){
  //console.log('making system_settings');

  var i;
  //var settingsCalculated = require('./settingsCalculated.js');

  // Load 'user' defined system_settings
  //var mk_settings = require('../data/system_settings.json.js');
  ...
  //system_settings.status_app.version_string = version_string;

  //system_settings = f.nullToObject(system_settings);
