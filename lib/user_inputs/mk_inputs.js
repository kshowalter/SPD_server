...
var mk_inputs = function(settings){
  ...
  settings.info.inputs = {
    contractor: {
      ...
      confirm_compliance_with_NEC_2014: {
        type: 'confirm',
        onDrawing: false,
        label: 'Does the PV system design and installation comply with all of the the requirements of the 2014 version of the NEC Article 690?'
      },
